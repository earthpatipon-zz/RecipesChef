...
//
//
// addRecipe(db, "Avocado on toast with smoked salmon","This dish comes in at under 300 calories", "Easy",15,2,
//                          "avocado 1\n" +
...
//
//
// addRecipe(db, "Chicken Katsu", "Japanese style fried chicken.", "Easy", 20,4,
...
//
//
// addRecipe(db, "Creamy herb chicken", "Quick and easy creamy herb chicken, filled with so much flavour, ready and on your table in 15 minutes",
//              "Easy" , 30, 4,
//                  "For The Chicken:\n" +
...
//                  "Diner", "American");
//
// addRecipe(db, "Gyoza" ,"They're great hot or cold, and may be eaten plain or with the dipping sauce. Any ground meat can be substituted for pork.",
//              "Medium" , 45, 8,
...
//                   "\n"
//                       "1.Heat sesame oil in a large skillet over medium high heat. Mix in cabbage, onion, garlic and carrot. Cook and stir until cabbage is limp.
...
//                       "3.Place approximately 1 tablespoon of the cabbage and pork mixture in the center of each wrapper.
//                          Fold wrappers in half over filling, and seal edges with moistened fingers.\n" +
//                       "4.In the preheated vegetable oil, cook gyoza approximately 1 minute per side, until lightly browned.
//                          Place water into skillet and reduce heat. Cover and allow gyoza to steam until the water is gone. In a small bowl, mix soy sauce and rice vinegar.
//                          Use the mixture as a dipping sauce for the finished wrappers.\n" ,
//                  "Orderf", "Japanese");
//
// addRecipe(db, "Red velvet cookies", "Inside out red velvet cookies"
//              "Medium", 45, 4,
...
//                      "4.Make cookies: Scoop about a tablespoon of the cookie dough and flatten into a flat, pancake-like circle. Spoon about 2 teaspoons of the cream cheese filling in the center. Form another tablespoon of cookie dough into a flat
//                          circle and place on top of filling. Pinch the edges together to seal, then roll the filled dough into a ball. Space cookies about 3" apart on prepared baking sheet.\n",
//                      "5.Bake cookies 15 to 17 minutes. Let cool slightly and serve.
//                  "Dessert");
//
// addRecipe(db, "Kimbap", "This easy kimbap somewhat resembles California roll, but as you can gather they taste different.",
//              "Easy", 35, 4,
...
//                      "2. Pre-heat a pan/skillet. Add a small dash of cooking oil and spread it around the pan. Add the beaten egg and cook both sides well over medium heat.
//                          Place the egg omelette on a cutting board and cut it into long strips.\n" +
//                      "3. In a heated pan, lightly cook the carrots, crab sticks and kimbap ham (about 1 min per ingredients), separately, and over medium heat. (Some people use these raw,
//                          but I prefer cooking them first for my kimbap.)\n" +
...
//                      "6. Place one dried seaweed sheet on the bamboo mat (shiny side down). Put the rice on the seaweed sheet then spread it evenly and thinly to cover about 2/3 of the seaweed.
...
//                  "Lunch", "Korean");
//
// addRecipe(db,"Korean candied sweet potatoes", "Try this popular Korean sweet potato recipe","Easy", 35, 4,
...
//                      "2.Combine brown sugar, flour, baking soda, salt, and rolled oats. Rub in the butter using your hands or a pastry blender
//                          to form a crumbly mixture. Press 2 cups of the mixture into the bottom of the prepared pan. Spread the jam to within 1/4 inch of the edge.
...
//                  "Dessert");
//
// addRecipe(db,"Restaurant Style Beef and Broccoli", "Very easy and delicious. Substituting chicken for the beef works great too. Serve over rice",
//             "Easy", 60, 4,
...
//                  "Main dish", "Chinese");
// addRecipe(db,"Spicy Thai basil chicken", "Thai dish has spectacular taste even with regular basil instead of Thai or holy basil",
//              "Easy", 15, 2,
...
//                  "Main dish", "Thai");
// addRecipe(db, "Strawberry cheesecake", "No-Bake Strawberry Cheesecake! Made with fresh berries, cashew butter, dates, and an easy almond crust. Creamy, dreamy, and actually pretty healthy."
//              "Hard", 140, 8,
